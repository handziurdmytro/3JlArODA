    ...
    <header className={styles.topbar}>
        ...
        <div className={styles.topbar__right}>
            ...
            <button className={styles.topbar__icon}>
                ...
                <path d="M76.3042 59C76.3042 68.5039 68.5998 76.2083 59.0959 76.2083C49.592 76.2083 41.8877 68.5039 41.8877 59C41.8877 49.4961 49.592 41.7917 59.0959 41.7917C68.5998 41.7917 76.3042 49.4961 76.3042 59Z" stroke="currentColor" stroke-width="7.5"/>
                </svg>
            </button>
